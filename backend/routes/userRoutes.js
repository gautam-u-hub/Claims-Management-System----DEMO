...
const { registerUser, loginUser, logout, forgotPassword, resetPassword, getUserDetails, updateUserPassword, updateUserProfile, getAllPolicyHolders, updateUserRole, isLoggedIn } = require("../Controllers/userController");
