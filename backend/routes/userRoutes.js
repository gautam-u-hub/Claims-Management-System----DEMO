...
const { registerUser, loginUser, logout, forgotPassword, resetPassword, getUserDetails, updateUserPassword, updateUserProfile, getAllPolicyHolders, updateUserRole, isLoggedIn, getAllUsers, deleteUserById } = require("../Controllers/userController");
...
router.route("/user/:id").delete(isAuthenticatedUser, authorizeRoles("admin"), deleteUserById);
