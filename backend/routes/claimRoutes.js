...
router.route("/TPA/claims").get(isAuthenticatedUser, authorizeRoles("TPA"), getAllClaims);
router.route("/TPA/claims/:id").get(isAuthenticatedUser, authorizeRoles("TPA"), getClaimById);

router.route("TPA/claims/:id").put(isAuthenticatedUser, authorizeRoles("TPA") ,updateClaimStatusById);
